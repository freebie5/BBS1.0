		...
		<div id="content" class="clearfix">
			<div id="main">
				<div id="wrap">
					<div class="passport">
						<h1 class="tit_1">
							<img src="images/tit_login.gif" title="用户登录" alt="用户登录" />用户注册
						</h1>
						<!-- login -->
						<div class="login">
							...
							<div id="tagContent">
								<div class="tagContent selectTag" id="tagContent0">
									...
									<div align="center" style="color:#F00">
										<s:property value="fieldErrors.registerError[0]"/>
									</div>
									<br/>
											...
											<tbody>
												<tr>
													...
													<td><input class="input_1 required" id="user_name"
														name="registerRequest.name" placeholder="用户名" tabindex="1" type="text" value="" /></td>
												</tr>
												<tr>
													<th>密码</th>
													<td><input class="input_1 required" id="password"
														name="registerRequest.password" tabindex="2" type="password" value="" /></td>
												</tr>
												<tr>
													<th>确认密码</th>
													<td><input class="input_1 required" id="password"
														name="registerRequest.password2" tabindex="3" type="password" value="" /></td>
												</tr>												
												<tr>
													<th>&nbsp;</th>
													<td><input type="submit" name="button" id="button"
														value="注　册" class="btn_1 submit" tabindex="4" /></td>
												</tr>
											</tbody>
										</table>
									</form>
